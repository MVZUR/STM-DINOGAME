...
{
/*	DrawTestPage("tekst1");
	Gui_StrCenter(0,30,RED,BLUE,"tekst2",16,1);//������ʾ
	Gui_StrCenter(0,60,RED,BLUE,"tekst3",16,1);//������ʾ
